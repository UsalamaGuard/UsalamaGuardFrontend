...
import { Zap, Linkedin, Github, Facebook } from "lucide-react";
    ...
    <div className="bg-gray-900 text-white min-h-screen overflow-hidden">
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-br from-blue-900 via-gray-800 to-black">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            Driving SkyViu’s AI capabilities with TensorFlow’s powerful machine learning framework.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            >
              ...
              <img src="/tensorflow.jpeg" alt="TensorFlow" className="relative z-10 w-full rounded-lg shadow-2xl border-4 border-blue-500" />
            </motion.div>
            <div className="w-full md:w-1/2">
              <h2 className="text-3xl font-semibold text-white">AI Precision</h2>
              <p className="mt-4 text-gray-400">
                TensorFlow fuels SkyViu’s AI algorithms, enabling rapid training and deployment of YOLO and SSD models for real-time anomaly detection. Its flexibility ensures our AI runs efficiently on edge devices and in the cloud.
              </p>
              <ul className="mt-4 text-gray-400 list-disc list-inside">
                <li>Training YOLO/SSD models for object detection.</li>
                <li>Optimized for edge computing with Nvidia Jetson.</li>
                <li>Scalable AI processing in AWS cloud environments.</li>
              </ul>
            </div>
          </div>
        </div>
