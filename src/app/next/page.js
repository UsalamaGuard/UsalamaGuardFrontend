...
import { Rocket, Linkedin, Github, Facebook } from "lucide-react";
    ...
    <div className="bg-gray-900 text-white min-h-screen overflow-hidden">
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-br from-blue-900 via-gray-800 to-black">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            Building SkyViu’s responsive, high-performance frontend with Next.js.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            >
              ...
              <img src="/next.png" alt="Next.js" className="relative z-10 w-full rounded-lg shadow-2xl border-4 border-purple-500" />
            </motion.div>
            <div className="w-full md:w-1/2">
              <h2 className="text-3xl font-semibold text-white">Dynamic Frontend</h2>
              <p className="mt-4 text-gray-400">
                Next.js powers SkyViu’s frontend, delivering a fast, SEO-friendly, and responsive user experience. With server-side rendering and WebSocket integration, it ensures our dashboards are both powerful and intuitive.
              </p>
