...
import { Cloud, Linkedin, Github, Facebook } from "lucide-react";
    ...
    <div className="bg-gray-900 text-white min-h-screen overflow-hidden">
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-br from-blue-900 via-gray-800 to-black">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            Powering SkyViu with scalable, secure cloud infrastructure from Amazon Web Services.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            >
              ...
              <img src="/aws.jpeg" alt="AWS Cloud" className="relative z-10 w-full rounded-lg shadow-2xl border-4 border-blue-500" />
            </motion.div>
            <div className="w-full md:w-1/2">
              <h2 className="text-3xl font-semibold text-white">Cloud-Powered Security</h2>
              <p className="mt-4 text-gray-400">
                SkyViu utilizes AWS for its robust cloud infrastructure, enabling secure data storage, real-time processing, and seamless scalability. Services like S3, Lambda, and IoT Core form the backbone of our platform.
              </p>
              <ul className="mt-4 text-gray-400 list-disc list-inside">
                <li>S3 for secure video and telemetry storage.</li>
                <li>Lambda for real-time AI processing.</li>
                <li>IoT Core for drone-to-cloud connectivity.</li>
              </ul>
            </div>
          </div>
        </div>
