...
import { Video, Linkedin, Github, Facebook } from "lucide-react";
    ...
    <div className="bg-gray-900 text-white min-h-screen overflow-hidden">
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-br from-blue-900 via-gray-800 to-black">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            Access live drone feeds and monitor threats in real time with SkyViu.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-purple-600 to-transparent opacity-50 rounded-full blur-3xl animate-pulse"></div>
              <img src="/live.jpeg" alt="Live Monitoring" className="relative z-10 w-full rounded-lg shadow-2xl border-4 border-purple-500" />
            </motion.div>
            <div className="w-full md:w-1/2">
              <h2 className="text-3xl font-semibold text-white">Real-Time Insights</h2>
              <p className="mt-4 text-gray-400">
                SkyViu’s live monitoring feature delivers high-definition drone feeds directly to your dashboard. Powered by WebRTC and WebSockets, it ensures low-latency streaming, allowing security teams to respond instantly to unfolding events.
              </p>
              <ul className="mt-4 text-gray-400 list-disc list-inside">
                <li>Live video streams from drone cameras.</li>
                <li>Low-latency delivery with WebRTC technology.</li>
                <li>Interactive dashboard for real-time control.</li>
              </ul>
            </div>
          </div>
        </div>
